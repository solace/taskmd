...
- [ ] After M1: raise thresholds to `statements: 60, branches: 80, functions: 65, lines: 60`
- [ ] After M2: raise thresholds to `statements: 70, branches: 83, functions: 75, lines: 70`
- [ ] After M3: raise thresholds to `statements: 78, branches: 86, functions: 83, lines: 78`
- [ ] After M4: raise thresholds to `statements: 83, branches: 88, functions: 88, lines: 83`
